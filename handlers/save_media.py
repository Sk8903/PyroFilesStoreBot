...
async def SaveBatchMediaInChannel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://playdisk.xyz/st?api=625eb8994fb6dcf3a2b045332253cb487afabafb&url=https://t.me/{Config.BOT_USERNAME}?start=SkTvOfficial_{str_to_b64(str(SaveMessage.message_id))}"
        await editable.edit(
...
async def SaveMediaInChannel(bot: Client, editable: Message, message: Message):
    try:
        ...
        share_link = f"https://playdisk.xyz/st?api=625eb8994fb6dcf3a2b045332253cb487afabafb&url=https://t.me/{Config.BOT_USERNAME}?start=SkTvOfficial_{str_to_b64(file_er_id)}"
        await editable.edit(
