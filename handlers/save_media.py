...
async def SaveMediaInChannel(bot: Client, editable: Message, message: Message):
    try:
        ...
        share_link = f"https://droplink.co/st?api=9d7e3a619ad96e9a2b8cda5f6b441212360ff052&url=https://t.me/{Config.BOT_USERNAME}?start=SkTvOfficial_{str_to_b64(file_er_id)}"
        await editable.edit(
