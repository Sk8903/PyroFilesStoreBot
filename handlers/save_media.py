...
async def SaveBatchMediaInChannel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://shrinkme.io/st?api=98da27fc363022dd2fb059f19c14c1669b8c4ad4&url=https://t.me/{Config.BOT_USERNAME}?start=SkTvOfficial_{str_to_b64(str(SaveMessage.message_id))}"
        await editable.edit(
...
async def SaveMediaInChannel(bot: Client, editable: Message, message: Message):
    try:
        ...
        share_link = f"https://shrinkme.io/st?api=98da27fc363022dd2fb059f19c14c1669b8c4ad4&url=https://t.me/{Config.BOT_USERNAME}?start=SkTvOfficial_{str_to_b64(file_er_id)}"
        await editable.edit(
